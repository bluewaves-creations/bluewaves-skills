...
### Fixed
- skill-eval: run_eval.py handles ToolSearch deferred tool loading and matches real installed skill names

### Changed
- athena-work: improved trigger description with explicit negative boundaries
