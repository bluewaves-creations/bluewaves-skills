...
5. **Render content pages:**
   ```bash
   python3 ${SKILL_ROOT}/../pdf-factory/scripts/render.py \
     --brand ${SKILL_ROOT}/../brand-<name> \
...
6. **Compose final document:**
   ```bash
   python3 ${SKILL_ROOT}/../pdf-factory/scripts/compose.py \
     --brand ${SKILL_ROOT}/../brand-<name> \
...
7. **Validate output:**
   ```bash
   python3 ${SKILL_ROOT}/../pdf-factory/scripts/validate_output.py \
     <output-path> \
     --brand ${SKILL_ROOT}/../brand-<name>
   ```
